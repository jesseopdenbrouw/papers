...
set output "ntc_gnuplot_pdfcairo.pdf"
...
A = 0.1
B = 5000.0
shh_beta(x) = A*exp(B/x)
fit shh_beta(x) "GegevensBetatherm10K3A542I.dat" using 5:2 via B,A
...
stats [1:2] "GegevensBetatherm10K3A542I.dat"
plot 'GegevensBetatherm10K3A542I.dat' using 5:2 with dots title "", shh_beta(x) title "" with lines
